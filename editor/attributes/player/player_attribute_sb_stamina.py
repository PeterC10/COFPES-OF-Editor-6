...
from editor.attributes.player.player_attribute_sb import (
    PlayerAttributeSb,
)

from editor.attributes.player.player_attribute_stamina import (
    PlayerAttributeStamina,
)
...
class PlayerAttributeSbStamina(PlayerAttribute):
    @classmethod
    ...
    def create_child_attributes(self):
        """
        Create SB and Stamina attributes
        and link to this attribute
        """
        self.sb = PlayerAttributeSb(self.player, parent=self)
        self.stamina = PlayerAttributeStamina(self.player, parent=self)
