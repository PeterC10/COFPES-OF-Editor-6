...
from editor.attributes.player.player_attribute_am import (
    PlayerAttributeAm,
)

from editor.attributes.player.player_attribute_dribble_accuracy import (
    PlayerAttributeDribbleAccuracy,
)
...
class PlayerAttributeAmDribbleAccuracy(PlayerAttribute):
    @classmethod
    def att_class_name(cls):
        return "AM/Dribble Accuracy"
    ...
    def create_child_attributes(self):
        """
        Create AM and Dribble Accuracy attributes
        and link to this attribute
        """
        self.am = PlayerAttributeAm(self.player, parent=self)
        self.dribble_accuracy = PlayerAttributeDribbleAccuracy(
