...
from editor.attributes.player.player_attribute_reaction import (
    PlayerAttributeReaction,
)

from editor.attributes.player.player_attribute_fk_accuracy import (
    PlayerAttributeFkAccuracy,
)
...
class PlayerAttributeReactionFkAccuracy(PlayerAttribute):
    @classmethod
    def att_class_name(cls):
        return "Reaction/Freekick Accuracy"
    ...
    def create_child_attributes(self):
        """
        Create Reaction and Freekick Accuracy attributes
        and link to this attribute
        """
        self.reaction = PlayerAttributeReaction(self.player, parent=self)
        self.fk_accuracy = PlayerAttributeFkAccuracy(
