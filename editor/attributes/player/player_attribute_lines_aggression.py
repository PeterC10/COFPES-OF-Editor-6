...
from editor.attributes.player.player_attribute_lines import (
    PlayerAttributeLines,
)

from editor.attributes.player.player_attribute_aggression import (
    PlayerAttributeAggression,
)
...
class PlayerAttributeLinesAggression(PlayerAttribute):
    @classmethod
    def att_class_name(cls):
        return "Lines/Aggression"
    ...
    def create_child_attributes(self):
        """
        Create Lines and Aggression attributes
        and link to this attribute
        """
        self.lines = PlayerAttributeLines(self.player, parent=self)
        self.aggression = PlayerAttributeAggression(self.player, parent=self)
