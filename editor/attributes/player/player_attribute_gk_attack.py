...
from editor.attributes.player.player_attribute_gk import (
    PlayerAttributeGk,
)

from editor.attributes.player.player_attribute_attack import (
    PlayerAttributeAttack,
)
...
class PlayerAttributeGkAttack(PlayerAttribute):
    @classmethod
    ...
    def create_child_attributes(self):
        """
        Create GK and Attack attributes
        and link to this attribute
        """
        self.gk = PlayerAttributeGk(self.player, parent=self)
        self.attack = PlayerAttributeAttack(self.player, parent=self)
