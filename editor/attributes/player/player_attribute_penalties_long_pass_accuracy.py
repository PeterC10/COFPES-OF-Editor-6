...
from editor.attributes.player.player_attribute_long_pass_accuracy import (
    PlayerAttributeLongPassAccuracy,
)
...
class PlayerAttributePenaltiesLongPassAccuracy(PlayerAttribute):
    @classmethod
    def att_class_name(cls):
        return "Penalties/Long Pass Accuracy"
    ...
    def create_child_attributes(self):
        """
        Create Penalties and Long Pass Accuracy attributes
        and link to this attribute
        """
        self.penalties = PlayerAttributePenalties(self.player, parent=self)
        self.long_pass_accuracy = PlayerAttributeLongPassAccuracy(
