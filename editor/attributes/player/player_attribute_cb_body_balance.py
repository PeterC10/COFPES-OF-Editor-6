...
from editor.attributes.player.player_attribute_cb import (
    PlayerAttributeCb,
)

from editor.attributes.player.player_attribute_body_balance import (
    PlayerAttributeBodyBalance,
)
...
class PlayerAttributeCbBodyBalance(PlayerAttribute):
    @classmethod
    def att_class_name(cls):
        return "CB/Body Balance"
    ...
    def create_child_attributes(self):
        """
        Create CB and BodyBalance attributes
        and link to this attribute
        """
        self.cb = PlayerAttributeCb(self.player, parent=self)
        self.body_balance = PlayerAttributeBodyBalance(self.player, parent=self)
