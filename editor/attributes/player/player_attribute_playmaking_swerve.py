...
from editor.attributes.player.player_attribute_playmaking import (
    PlayerAttributePlaymaking,
)

from editor.attributes.player.player_attribute_swerve import (
    PlayerAttributeSwerve,
)
...
class PlayerAttributePlaymakingSwerve(PlayerAttribute):
    @classmethod
    def att_class_name(cls):
        return "Playmaking/Shot Accuracy"
    ...
    def create_child_attributes(self):
        """
        Create Playmaking and Shot Accuracy attributes
        and link to this attribute
        """
        self.playmaking = PlayerAttributePlaymaking(self.player, parent=self)
        self.swerve = PlayerAttributeSwerve(
