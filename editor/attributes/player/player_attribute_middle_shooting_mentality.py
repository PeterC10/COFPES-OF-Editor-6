...
from editor.attributes.player.player_attribute_middle_shooting import (
    PlayerAttributeMiddleShooting,
)

from editor.attributes.player.player_attribute_mentality import (
    PlayerAttributeMentality,
)
...
class PlayerAttributeMiddleShootingMentality(PlayerAttribute):
    @classmethod
    def att_class_name(cls):
        return "Middle Shooting/Mentality"
    ...
    def create_child_attributes(self):
        """
        Create Middle Shooting and Mentality attributes
        and link to this attribute
        """
        self.middle_shooting = PlayerAttributeMiddleShooting(
            self.player, parent=self
        )
        self.mentality = PlayerAttributeMentality(self.player, parent=self)
