...
from editor.attributes.player.player_attribute_cm import (
    PlayerAttributeCm,
)

from editor.attributes.player.player_attribute_response import (
    PlayerAttributeResponse,
)
...
class PlayerAttributeCmResponse(PlayerAttribute):
    @classmethod
    ...
    def create_child_attributes(self):
        """
        Create CM and Response attributes
        and link to this attribute
        """
        self.cm = PlayerAttributeCm(self.player, parent=self)
        self.response = PlayerAttributeResponse(self.player, parent=self)
