...
from editor.attributes.player.player_attribute_one_on_one_scoring import (
    PlayerAttributeOneOnOneScoring,
)

from editor.attributes.player.player_attribute_teamwork import (
    PlayerAttributeTeamwork,
)
...
class PlayerAttributeOneOnOneScoringTeamwork(PlayerAttribute):
    @classmethod
    def att_class_name(cls):
        return "1-1 Scoring/Teamwork"
    ...
    def create_child_attributes(self):
        """
        Create OneOnOneScoring and Teamwork attributes
        and link to this attribute
        """
        self.one_on_one_scoring = PlayerAttributeOneOnOneScoring(
            self.player, parent=self
        )
        self.teamwork = PlayerAttributeTeamwork(self.player, parent=self)
