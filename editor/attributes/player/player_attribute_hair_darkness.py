...
class PlayerAttributeHairDarkness(PlayerAttribute):
    @classmethod
    def att_class_name(cls):
        return "Hair Darkness"
    ...
    def get_label(self):
        ...
        and return first value (hair darkness is set fifth)
        """
    ...
    def set_value_from_label(self, label):
        ...
        hair_key = replace_tuple_at_index(hair_key, 4, label)
